...
function CategoryOptionClothing(props) {
    return (
        <div className='CategoryOptions'>
            <div className="row m-0">
                <div className="col-4 py-4" style={{ paddingLeft: "30px", background: "rgb(247, 247, 247)" }}>
                    ...
                    {(props.currentPage === 'CategoryOptionClothing') ?
                        <>
                            <Link to="/category/clothing" style={{ fontWeight: "500", textDecoration: "none", color: "black", fontSize: "18px", paddingBottom: "25px", paddingTop: "25px" }}>Clothing<br /><br /></Link><br />
                        </>
                        :
                        <>
...
export default CategoryOptionClothing;
